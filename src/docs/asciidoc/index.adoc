...
=== Create payout
Creates payout Merkle tree for the specified parameters. Path arguments in order are: chain ID, asset contract address.

.Request
include::{snippets}/PayoutControllerApiTest/mustSuccessfullyCreatePayoutForSomeAsset/http-request.adoc[]
.Response
include::{snippets}/PayoutControllerApiTest/mustSuccessfullyCreatePayoutForSomeAsset/http-response.adoc[]
