...
CREATE INDEX merkle_tree_leaf_node_root_idx
    ON payout_service.merkle_tree_leaf_node(merkle_root);
CREATE INDEX merkle_tree_leaf_node_exists_idx
    ON payout_service.merkle_tree_leaf_node(merkle_root, address, balance);
